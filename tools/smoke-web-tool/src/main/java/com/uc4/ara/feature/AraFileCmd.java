...
public class AraFileCmd {
	...
	public static void main(String[] args) {
		FeatureUtil.logMsg("smoke-web-tool", MsgTypes.GENERAL);
		FeatureUtil.logMsg("(c) Automic Software GmbH", MsgTypes.GENERAL);
		try {			
			FeatureUtil.logMsg("Version: "
					+ FeatureUtil.getCompiledVersion("smoke-web-tool"), MsgTypes.GENERAL);
			
			FeatureUtil.logMsg("Date: "
					+ FeatureUtil
					.getCompiledDate("smoke-web-tool"), MsgTypes.GENERAL);
			FeatureUtil.logMsg("");
